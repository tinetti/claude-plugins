...
// ../../../node_modules/.pnpm/@modelcontextprotocol+sdk@0.6.0/node_modules/@modelcontextprotocol/sdk/dist/types.js
...
// ../../../node_modules/.pnpm/@modelcontextprotocol+sdk@0.6.0/node_modules/@modelcontextprotocol/sdk/dist/shared/protocol.js
...
// ../../../node_modules/.pnpm/@modelcontextprotocol+sdk@0.6.0/node_modules/@modelcontextprotocol/sdk/dist/server/index.js
...
// ../../../node_modules/.pnpm/@modelcontextprotocol+sdk@0.6.0/node_modules/@modelcontextprotocol/sdk/dist/server/stdio.js
import process2 from "node:process";

// ../../../node_modules/.pnpm/@modelcontextprotocol+sdk@0.6.0/node_modules/@modelcontextprotocol/sdk/dist/shared/stdio.js
...
// src/utils.ts
async function callGPT5(apiKey, input, options = {}) {
  const messages = [];
  ...
  if (!response.ok) {
    ...
    throw new Error(
      `GPT-5 API error: ${response.status} ${response.statusText} - ${errorText}`
    );
  }
...
async function callGPT5WithMessages(apiKey, messages, options = {}) {
  const allMessages = [];
  if (options.instructions) {
    allMessages.push({
      role: "developer",
  ...
  console.error(
    "Making GPT-5 API request with messages:",
    JSON.stringify(requestBody, null, 2)
  );
  const response = await fetch("https://api.openai.com/v1/chat/completions", {
    method: "POST",
...
// src/index.ts
var GPT5GenerateSchema = external_exports.object({
  input: external_exports.string().describe("The input text or prompt for GPT-5"),
  model: external_exports.string().optional().default("gpt-5").describe("GPT-5 model variant to use"),
  instructions: external_exports.string().optional().describe("System instructions for the model"),
  reasoning_effort: external_exports.enum(["low", "medium", "high"]).optional().describe("Reasoning effort level")
});
var GPT5MessagesSchema = external_exports.object({
  messages: external_exports.array(
    external_exports.object({
      role: external_exports.enum(["user", "developer", "assistant"]).describe("Message role"),
