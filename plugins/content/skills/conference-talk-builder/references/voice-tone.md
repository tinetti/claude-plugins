...
When speaking on stage vs writing blog posts:

- **More casual** — contractions, incomplete sentences, conversational asides
- **More humor** — self-deprecating jokes land better live, audience energy feeds back
- **More repetition** — key points repeated for emphasis since audience can't re-read
- **More pauses** — speaker notes should indicate beats, silences, and moments to let things land
- **More questions** — rhetorical and real, engage the audience directly
- **Shorter sentences** — spoken rhythm is different from written rhythm
