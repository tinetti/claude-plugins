...
Executes a spec file generated by the ideation skill. Reads the spec, creates todos, and implements step-by-step with validation.
...
2. Create todos from implementation details
